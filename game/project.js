...
entriesmap.forEach((row, i) => {
    row.forEach((symbol, j)=>{
        ...
        if (symbol ===4)Entries.push(new Entryroom({
            ...
            color:"yellow",
            destination:"git/snake"
        })
        );
        if (symbol ===5)Entries.push(new Entryroom({
            position:{
                x: j*Entryroom.width + offset.x,
                y: i*Entryroom.height + offset.y
            },
            color:"white",
            destination:"git/graph"
        })
        );
        if (symbol ===6)Entries.push(new Entryroom({
            position:{
                x: j*Entryroom.width + offset.x,
                y: i*Entryroom.height + offset.y
            },
            color:"green",
            destination:"git/esport"
        })
        );
    })
})
...
foregroundImage.src ='./assets/img/projects/foreground.png';

const mapImage = new Image();
mapImage.src ='./assets/img/projects/map.png';
...
function redirection(entry){
    ...
    if(entry.color=="blue"){
        document.location.href="https://github.com/leocoste";
    }
    if(entry.color=="pink"){
        document.location.href="https://github.com/leocoste/projet-power-BI";
    }
    if(entry.color=="yellow"){
        document.location.href="https://github.com/leocoste/Projet-snake";
    }
    if(entry.color=="white"){
        document.location.href="https://github.com/leocoste/projet-graph-map";
    }
    if(entry.color=="green"){
        document.location.href="https://github.com/leocoste/projet-planet-e-sport";
    }
}
