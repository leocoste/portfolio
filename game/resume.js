...
entriesmap.forEach((row, i) => {
    row.forEach((symbol, j)=>{
        if (symbol ===2184)Bondaries.push(new Bondaryroom({
            position:{
...
foregroundImage.src ='./assets/img/resume/foreground.png';

const mapImage = new Image();
mapImage.src ='./assets/img/resume/map.png';
...
function redirection(entry){
    ...
    if(entry.color=="blue"){
        document.location.href="../assets/cv.pdf";
    }
}
...
window.addEventListener('keydown',(e)=>{
    switch(e.key){
        ...
        case 'Control':
            ...
            break;
        case 'Escape':
            cdocument.location.href="../index.html";
            break;
    }
});
